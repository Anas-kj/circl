...
import StyledContactModel from "./styles"
...
import { closeModel } from "@utils/ModelFunction"
import { setupAnimation } from "@utils/gsap/ContactModel"
import { SymbolWhite } from "public/assets"
...
const ContactModel = ({}) => {
  ...
  return (
    <StyledContactModel isRTL={isRTL}>
      <div className="model-overlay">
        <Container>
          <div className="header">
            ...
            <div className="contact-model-navigation">
              <div className="logo-symbol" onClick={closeModel}>
                <SymbolWhite />
              </div>
              <div className="back" onClick={closeModel}>
                {t("contact_model_back_btn")}
              </div>
            </div>
          </div>
                ...
                <div className="checkboxes">
                  ...
                  <div className="checkbox-item">
                    <input
                      ...
                      value={"LinkedIn"}
                      name="contact"
                      checked={contactOption === "LinkedIn"}
                      onChange={() => {
                  ...
                  <div className="checkbox-item">
                    <input
                      ...
                      value={"WhatsApp"}
                      name="contact"
                      checked={contactOption === "WhatsApp"}
                      onChange={() => {
                ...
                <div className="checkboxes">
                  <div className="checkbox-item">
                    <input
                      ...
                      name="duologue"
                      checked={
                        duologue === null || duologue === false ? false : true
                      }
                      onChange={() => {
                        setDuologue(true)
                      }}
                  ...
                  <div className="checkbox-item">
                    <input
                      ...
                      name="duologue"
                      checked={
                        duologue === null || duologue === true ? false : true
                      }
                      onChange={() => {
                        setDuologue(false)
                      }}
